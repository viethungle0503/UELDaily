    ...
    <View style={styles.body}>
     ...
     <ScrollView style={styles.monthi}>
      ...
      <View style={styles.monthi_Item}>
        ...
        <Text style={styles.monthi_Item__SubjectName} >Phát triển web kinh doanh - 221MI2602 
        </Text>
      ...
      <View style={styles.monthi_Item}>
        ...
        <Text style={styles.monthi_Item__SubjectName} >Hệ quản trị cơ sở dữ liệu - 221MI6602  
        </Text>
