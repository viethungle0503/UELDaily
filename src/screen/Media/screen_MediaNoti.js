...
import {setSingleNews_Departments} from '../../redux_toolkit/newsSlice';
...
export default function MediaNoti({navigation, route}) {
                ...
                <TouchableOpacity
                  ...
                  <ImageBackground
                    ...
                    <LinearGradient
                      ...
                      style={
                        styles.lastestItem_linearGradient
                      }></LinearGradient>

                    <View style={styles.lastestItem_Content}>
                      <Text
                        style={[
                          styles.lastestItem_ContentText,
                          {
                            fontSize: 17,
                            fontWeight: '600',
                          },
                      ...
                      <View style={styles.row}>
                        <Image
                          style={styles.mediaNotiItem_DepartmentImage}
                        ...
                        <Text style={styles.mediaNotiItem_ContentTime}>
                          &nbsp;{item.time.substr(1, 10)}
                        </Text>
                      </View>
                    </View>
                  </ImageBackground>
  ...
  useEffect(() => {
    ...
    const bigNewsAsync = async () => {
      await news_Departments[index].data.forEach(async (value, index) => {
        await Image.getSize(
          value.imageURL,
          (imgWidth, imgHeight) => {
  ...
  useEffect(() => {}, [currentLanguage, ready]);
  return (
          ...
          renderItem={({item}) => {
            return (
              <TouchableOpacity
                ...
                <Image
                  style={styles.mediaNotiItem_Image}
                  source={{uri: item.imageURL}}
                />

                <View style={styles.mediaNotiItem_Content}>
                  <Text style={styles.mediaNotiItem_ContentTitle}>
                    {item.title}
                  </Text>
